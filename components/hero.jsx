        ...
        <section className="w-full pt-36 md:pt-48 pb-10">
            <div className="space-y-6 text-center">
                <div className="space-y-6 mx-auto">
                    ...
                    <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl">Advance your career with personalised guidance, interview preparartion, and AI-powered tools for job success.</p>
                </div>
